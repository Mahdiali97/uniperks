  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: MagicalLogoReveal(
        // 🎨 Customize your logo with UniPerks branding
        logo: Container(
          width: 140,
          height: 140,
        ...
        // 🎨 Tagline (optional)
        tagline: "Fun More Pay Less",

        // ⚙️ Customization parameters
        animationDuration: const Duration(milliseconds: 1200),
        glowColor: const Color(0xFF0066CC),
        ...
        backgroundGradientColors: [
          ...
          [Colors.white, const Color(0xFF90CAF9)],
          [Colors.white, const Color(0xFFE3F2FD)],
        ],
      ),
    );
...
class _MagicalLogoRevealState extends State<MagicalLogoReveal>
  ...
  void _startGradientAnimation() {
    _gradientTimer = Timer.periodic(const Duration(milliseconds: 2000), (
      timer,
    ) {
      if (mounted) {
        setState(() {
          _currentGradientIndex =
              (_currentGradientIndex + 1) %
